...
-spec control_queue(kapps_call:call() | pid()) -> api_control_q().
-spec control_queue(api_binary(), kapps_call:call() | pid()) -> api_control_q().
...
%% @private
-spec cf_module_task(atom(), list(), kapps_call:call(), pid(), pid()) -> any().
